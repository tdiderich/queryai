...
def check_async_search_status(tracking_id: str):
    ...
    while gathering_results:
        search_results = client.get(path='search_async', params={
...
if __name__ == '__main__':
    ...
    search_results = run_async_search_with_relative_lookback(
        query=query, platform_aliases=platform_aliases, relative_lookback_minutes=30)
